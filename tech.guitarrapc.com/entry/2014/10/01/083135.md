...
一つだけ約束できます。Tech Preview を触るということは、**アナタが世界で初めてあらゆる機能テストを行える人**ということです。
...
ただ戻すだけではなく、どうすればユーザーにとって使いやすいのか((User Experience))、画期的な新機能の追加 ((Terrific New Improvement)) この二つのバランスを慎重に考えました。
