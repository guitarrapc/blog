...
以前公開した以下での日付取得を少し改良してみました。 <a href="http://guitarrapc.wordpress.com/2012/12/18/%e3%83%90%e3%83%83%e3%83%81%e3%81%a7powershell%e3%81%ae%e5%87%ba%e5%8a%9b%e5%86%85%e5%ae%b9%e3%82%92%e5%8f%97%e3%81%91%e5%8f%96%e3%82%8b/" target="_blank">バッチでPowershellの出力内容を受け取る</a> 用意したのは、昨日を取得すること限定版、任意の日付を取得する版、のサンプル2つです。これで、バッチで任意の日付をセットすることの不自由さは完全に回避されました。 長年の悩みがここまですっきり自己解決出来てハッピーです。
# 前回からの変更点：
