...
`$env:USERPROFILE\Documents\WindowsPowerShell\Modules\RespClient\RespClient.dll`に配置すれば、PowerShell V3以降であれば、モジュールとして自動読み込まれるのでいい感じでしょう。
...
戻り値はUTF-8Stringで、デコードされています。PowerShell的にもUTF8は望ましいのでいい感じでしょう。
