...
| ----|----|---- |
| 1|DSC|[Holiday Gift – Desired State Configuration (DSC) Resource Kit Wave-1](https://blogs.msdn.com/b/powershell/archive/2013/12/26/holiday-gift-desired-state-configuration-dsc-resource-kit-wave-1.aspx)
...
これらに触ったこともない方はぜひ触ってください。そして触って判断してください。
まだまだ物足りない点も数多くあります。しかし、PowerShellはバージョンを重ねるごとに確実に進化をしています。どうか、試してみて、使える点があるなら使ってみてください。
...
文字通り、構造化されたオブジェクトを文字列コンテンツとして出力する機能です。
