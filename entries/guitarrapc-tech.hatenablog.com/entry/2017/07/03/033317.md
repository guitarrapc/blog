...
ケーブルをいかに減らすかってチャレンジは楽しいです。7260HMWDTX1はそんなにオススメできないけど、デスクトップをWi-Fiにするにはいい感じです。USBのWi-Fi子機をいくつか試してきたんですが、やはりボード差し込みのほうがおススメです。これはアンテナ自由に配置できるし。((モニタ裏に私は配置しています。))
