---
Title: コンテナでGUIアプリケーションを動かしてホストからVNC/RDPで操作する
Category:
- Container
...
[Dockerfile](https://github.com/guitarrapc/docker-jmeter-gui/blob/5.6.3-legacy/src/ubuntu24.04/Dockerfile)[^2]を示します。
...
[xrdp.ini](https://github.com/guitarrapc/docker-jmeter-gui/blob/5.6.3-legacy/xrdp.ini)は以下の通りです。
