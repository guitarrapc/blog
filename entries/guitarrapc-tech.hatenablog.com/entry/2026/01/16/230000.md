...
[f:id:guitarrapc_tech:20260119172349p:plain:alt=SLSAの例]<!--image.png-->
...
[f:id:guitarrapc_tech:20260119172357p:plain:alt=SBOMをエキスポート]<!--image-1.png-->
...
SBOMはフォーマットがあるにも関わらず、ツールによって生成結果が微妙に異なっており一貫したフォーマット提供に[課題](https://zenn.dev/nttdata_tech/articles/72c03b32f624d5)があります。ツールによって含まれるコンポーネント数が違うのはしょうがないとしても、依存階層が一致しないとか困ったものです。
...
- [SBOMはなぜ揃わないのか：Plugfestの知見と3ツール比較から見えた現実 | Zenn](https://zenn.dev/nttdata_tech/articles/72c03b32f624d5)
