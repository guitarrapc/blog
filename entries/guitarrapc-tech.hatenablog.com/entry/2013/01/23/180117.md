...
問題4 gc num.txt|select @{L="R";E={$_ - $_%10}}|group R|sort @{E={[int]($_.Name)}}|select Count,@{N="Range";E={"$($_.Name)～$(9+$_.Name)"}}
— 牟田口大介さん (@mutaguchi) <a href="https://twitter.com/mutaguchi/status/294285289181032449">1月 24, 2013</a>
<blockquote class="twitter-tweet" lang="ja">
gc num.txt|%{$_ - $_%10}|group|sort @{E={[int]$_.name}}|%{"$($_.Name)～$(9+$_.Name) $($_.Count)"}　オブジェクトとかにこだわらない方が簡潔ですねえ…
— 牟田口大介さん (@mutaguchi) <a href="https://twitter.com/mutaguchi/status/294288920395534336">1月 24, 2013</a>
## 問題5: Fizz Buzz
  これは先行して別記事で解いていますので、こちらを参照してください。
<a href="http://guitarrapc.wordpress.com/2013/01/19/powershell%e3%81%a7fizzbuzz%e3%81%97%e3%81%a6%e3%81%bf%e3%82%8b/" target="_blank">PowerShellでFizzBuzzしてみる</a>
## 問題6: 日付の計算
...
<blockquote class="twitter-tweet" lang="ja">
問題6　New-Timespan 1978/2/16 2012/10/27|select -Expand TotalDays
— 牟田口大介さん (@mutaguchi) <a href="https://twitter.com/mutaguchi/status/294252687023820800">1月 24, 2013</a>
なるほどー…ふむふむ。
<a href="http://technet.microsoft.com/ja-jp/library/ee176916.aspx" target="_blank">TechNet - New-Timespan コマンドレットの使用</a>
...
<blockquote class="twitter-tweet" lang="ja">
問題7-1 1..10|Get-Random -Count 10|select -First 9|Set-Content num.txt
— 牟田口大介さん (@mutaguchi) <a href="https://twitter.com/mutaguchi/status/294253125987098624">1月 24, 2013</a>
ほむ…
<a href="http://technet.microsoft.com/en-us/library/ff730929.aspx" target="_blank">TechNet - The Get-Random Cmdlet</a>
...
この辺で勉強したり。
<a href="http://powershell.com/cs/blogs/tips/archive/2009/02/26/advanced-compare-object-working-with-results.aspx" target="_blank">Advanced Compare-Object: Working with Results</a>
...
<blockquote class="twitter-tweet" lang="ja">
問題6めんどいな。CPU %とる簡単な方法がない。プロセスごとにCPU時間を2回取得して、取得間隔とCPUコア数で割れば出るんだけども。
— 牟田口大介さん (@mutaguchi) <a href="https://twitter.com/mutaguchi/status/294263485817315328">1月 24, 2013</a>
<blockquote class="twitter-tweet" lang="ja">
あとプロセス所有ユーザー名はGet-Processじゃ取れないのでGet-WMIObject win32_process|%{$_.getowner().user}とかで。
— 牟田口大介さん (@mutaguchi) <a href="https://twitter.com/mutaguchi/status/294264219287842816">1月 24, 2013</a>
## 問題9: 横にならんだ数字のソート
<del datetime="2013-01-23T18:27:12+00:00">飽きた</del>前回の第二回でやったことと同様なので…省略 ( ※[Jan/25/2013 追記] 牟田口先生が書かれていたので参考に。
<blockquote class="twitter-tweet" lang="ja">
問題9-1 1..3|%{(1..(Get-Random -Minimum 3 -Maximum 7)|%{Get-Random -Minimum 0-Maximum 500}) -join " "}|sc file.txt ていうかそこ問題じゃなかった予感
— 牟田口大介さん (@mutaguchi) <a href="https://twitter.com/mutaguchi/status/294259779155668992">1月 24, 2013</a>
<blockquote class="twitter-tweet" lang="ja">
問題9-2 gc .\file.txt|%{([int[]]($_ -split " ")|sort) -join " "}
— 牟田口大介さん (@mutaguchi) <a href="https://twitter.com/mutaguchi/status/294260399195435008">1月 24, 2013</a>
## 問題10: 横にならんだ数字のソート
<del datetime="2013-01-23T18:27:12+00:00">飽きた</del>…省略 ( ※[Jan/25/2013 追記] 牟田口先生が書かれていたので参考に。
<blockquote class="twitter-tweet" lang="ja">
問題10がよくわからないけど$a=gc teams;$a|%{"," + ($a -join ",")} {$_ + "," * <a href="https://twitter.com/search/$a">$a</a>.length} こういうことでいいのかな？
— 牟田口大介さん (@mutaguchi) <a href="https://twitter.com/mutaguchi/status/294258129418473472">1月 24, 2013</a>
## まとめ
