...
<a href="http://ttssh2.sourceforge.jp/manual/ja/commandline/teraterm.html" target="_blank">Tera Term Pro コマンドライン</a>
...
- 一度入力した内容は、jsonでファイル保持します。
今回の場合は、tterapro.exeと秘密鍵パスと接続先hostです。
- CUIではなくXamlでGUIライクに
...
**Xaml (GUI) バージョン：**
https://github.com/guitarrapc/PowerShellUtil/blob/master/TeraTermConnection/teraterm_xaml.ps1

**CUIバージョン：**
https://github.com/guitarrapc/PowerShellUtil/blob/master/TeraTermConnection/Enter-Teraterm.ps1
