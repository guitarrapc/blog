...
気になるアレがありました。
<a href="http://oshiete.goo.ne.jp/qa/2257403.html?from=recommend" target="_blank">シェルコマンドの 2&gt;&amp;1　とはどういう意味でしょうか？</a>
...
最後に、今回のテストコードを掲載しておきます。 敢えて大袈裟にしてみました (( <del datetime="2013-04-02T20:18:36+00:00">本体よりparam()の方が長い</del>
...
DefaultParameterSetName を利用しているので、switchは一つだけ選べるようにしてあります。((<span style="line-height: 1.5;">-do11 を選ぶと -do12などは出なくなる))
