...
NuGetはソフトウェアサプライチェインと脆弱性について[ドキュメント](https://learn.microsoft.com/en-us/nuget/concepts/security-best-practices)を出しています。ここには`Knowing what is in your environment`項目があげられているのですが、init.ps1の「インストール時に追加実行できるスクリプト」という性質は攻撃したいと思ったときに非常に都合がよいです。
