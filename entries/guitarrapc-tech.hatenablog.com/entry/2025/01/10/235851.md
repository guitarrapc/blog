...
アンインストールしたならOSのコマンド探索に任されるのが自然だと思うのですが....果たしてどうやったらできるのか。
...
もともと手動でツールインストールするのに疲弊してasdfを使い始めました。長年asdfにお世話になっていたのですが、昨今のOSSに対する攻撃を見ていてasdfを継続して使うか手動に戻すか悩むようになりました。1年ほど悩んだ末aquaに移行しています。
