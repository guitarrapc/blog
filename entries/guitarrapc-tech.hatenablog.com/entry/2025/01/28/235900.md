...
ARM64に対応した[続き](https://tech.guitarrapc.com/entry/2025/11/18/013000)を書きました。
...
`ConvertToString`で`Eax-Edx`各レジスタをバイト列に変換してASCII文字列として結合します。StringBuilderで次のように書いてもいいのですが、今回はSpanを使って高速化しています。
