...
.csprojで行っているNuGetパッケージ定義をCentral Package Managementに移行するには手作業が必要でしたが、Visual Studio 2022と`.NET Upgrade Assistant拡張`を使うとCentral Package Managementへ簡単以降できるようになったので紹介します。
