...
<figure class="figure-image figure-image-fotolife" title="https://devblogs.microsoft.com/dotnet/announcing-dotnet-chiseled-containers/ より">[f:id:guitarrapc_tech:20250926190002p:plain]<figcaption>https://devblogs.microsoft.com/dotnet/announcing-dotnet-chiseled-containers/ より</figcaption></figure><!-- image.png -->
...
TechEmpowerでのスコアはC#ランタイムやASP.NET CoreのIssueでもたびたび参照されており、C#のパフォーマンス改善に関する議論で引用・改善結果が報告されているものの、あくまでも参考程度にどうぞ。[^8]

<figure class="figure-image figure-image-fotolife" title="TechEmpower Round23 - Plaintext">[f:id:guitarrapc_tech:20250927082653p:plain]<figcaption>TechEmpower Round23 - Plaintext</figcaption></figure> <!-- image-1.png -->
