...
当初はこれでも気にならなかったのですが、いくつかのZenn記事でリンク前後に半角スペースを入れている文章を読んでいて、リンク部分が色の違いだけでなくわずかなスペースがあることで詰まっている印象が減っていました。ただ、半角スペースほど広げる必要はなく1,2px程度で十分です。そこで、`a`タグの前後に`padding: 0 2px`を追加しています。
