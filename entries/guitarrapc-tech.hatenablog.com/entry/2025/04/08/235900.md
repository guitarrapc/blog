...
[はてなブログ開発ブログ](https://staff.hatenablog.com/entry/2014/12/16/120000)によると、みたままモードの記事からMardownモードへの変換をサポートしていません。このため、みたままモードの記事を一度消してから、同じ日付でMarkdownモードの記事を新たに作成します。
