...
Category:
- C#
Date: 2025-02-11T01:41:19+09:00
...
特に、[プロジェクトのコード規約はMicrosoftのC#コード規則](https://learn.microsoft.com/ja-jp/dotnet/csharp/fundamentals/coding-style/coding-conventions)と謡うC#erは多く見かけます。それを規約とするなら、[.editorconfigでコードルールを設定する](https://learn.microsoft.com/en-us/dotnet/fundamentals/code-analysis/code-style-rule-options)と明解、かつ個人のIDE/エディター設定に依存せず、IDEのフルサポートを受けられるのでオススメです。
