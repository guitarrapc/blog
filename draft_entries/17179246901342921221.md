...
Dockerコンテナ上でJMeter GUIを動作させるコンテナイメージ[guitarrapc/docker-jmeter-gui](https://github.com/guitarrapc/docker-jmeter-gui)を公開しているのですが、このコンテナイメージ作成を通じて、コンテナのGUIをホストから操作する方法をいくつか試していました。

今回は、GUI込みのコンテナに、ホストからRDP/VNCで接続する方法を紹介します。
