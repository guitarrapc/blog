...
| ---| --- | --- |
接続画面 | ![WindowsからRemote Desktop Connectionで接続する](image.png) <!--image.png--> | ![VNCで接続する](image-2.png) |
| ログイン画面 | ![XServerログイン画面](image-1.png) <!--image-1.png--> | ![VNCパスワードの入力](image-3.png) <!--image-3.png--> |

接続に成功するとJMeter GUIが表示されます。

![JMeterの画面](image-4.png)
