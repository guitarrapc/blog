...
[f:id:guitarrapc_tech:20251220043021p:plain:alt=GitHub Actionsにおけるアクセストークンの選択方針フローチャート]
...
[f:id:guitarrapc_tech:20251220043030p:plain:alt=設定全般]

[f:id:guitarrapc_tech:20251220043038p:plain:alt=権限設定]
...
[f:id:guitarrapc_tech:20251220043045p:plain:alt=alt text]

[f:id:guitarrapc_tech:20251220043051p:plain:alt=alt text]

Private Keyを生成するとダウンロードされるので、中身をSecretsに登録したらファイルは消しましょう。秘密鍵はすぐ消すに限ります。

[f:id:guitarrapc_tech:20251220043057p:plain:alt=alt text]

[f:id:guitarrapc_tech:20251220043104p:plain:alt=alt text]
...
[f:id:guitarrapc_tech:20251220043111p:plain:alt=GitHub Actions Appをインストールするとリポジトリアクセスを指定できる]

インストール後にGitHub Appの権限を変更した場合、組織のオーナーは変更を承認するか選択できます。

インストールしたアプリを削除もできます。

[f:id:guitarrapc_tech:20251220043119p:plain:alt=alt text]
...
[f:id:guitarrapc_tech:20251220043127p:plain:alt=ワークフローの実行結果]
