...
[f:id:guitarrapc_tech:20251220043045p:plain:alt=alt text]<!--image-3.png-->

[f:id:guitarrapc_tech:20251220043051p:plain:alt=alt text]<!--image-4.png-->

Private Keyを生成するとダウンロードされるので、中身をSecretsに登録したらファイルは消しましょう。秘密鍵はすぐ消すに限ります。

[f:id:guitarrapc_tech:20251220043057p:plain:alt=alt text]<!--image-5.png-->

[f:id:guitarrapc_tech:20251220043104p:plain:alt=alt text]<!--image-6.png-->
...
[f:id:guitarrapc_tech:20251220043119p:plain:alt=alt text]<!--image-9.png-->
...
[^2]: CopilotのアサインにはCopilotライセンスが必要なため、PATから逃げられません。Copilot AgentをGitHub Actionsからghで割り当てるのにほしい。
