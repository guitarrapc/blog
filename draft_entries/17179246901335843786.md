...
![GitHub Copilotのユースケース例](image.png)
...
![インストラクションを入れない場合](image-8.png)

同インストラクションを入れると、PRや直近コミットになくても、ドキュメント全体の言語を統一してくれます。

![インストラクションを入れた場合](image-9.png)
