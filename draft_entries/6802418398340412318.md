...
This is the greate message from <a href="http://social.technet.microsoft.com/Profile/jeffrey%20snover%20windows%20server" target="_blank">Jeffret Snover</a> about **"The way Microsoft is focusing."** and **"How PowerShell Automate with DataCenter."**.

Here's the Keynotes for anyone who don't kwnow.
<a href="http://vimeo.com/58086670" target="_blank">NICconf Opening and Keynote: Modernizing Windows Server/Modernizing Ourselves - by Jeffrey Snover</a>
