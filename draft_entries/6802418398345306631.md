...
CustomPath: 2025/03/29/235900
Draft: true
---

[Amazon EFS](https://aws.amazon.com/jp/efs/)といえば、ECS/EKS/EC2問わず複数マシンで単一ボリュームを参照させるに当たり非常に便利な代物です。
...
![EFSからS3へのDataSync構成図](image-2.png)
