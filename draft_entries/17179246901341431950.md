...
![要素の多いレイアウト例](image.png)<!--image.png-->
...
![deployment.yamlのアーキテクチャ図](image-1.png)<!--image-1.png-->
...
![Kustsomizeからのアーキテクチャ図生成](image-2.png)<!--image-2.png-->
...
![helm templateからのアーキテクチャ図生成](image-3.png)<!--image-3.png-->
...
![EKSのリソースからアーキテクチャ図生成の例](image-4.png)<!--image-4.png-->
...
![ArgoCDのアーキテクチャ図生成の例](image-5.png)<!--image-5.png-->
