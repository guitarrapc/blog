...
[f:id:guitarrapc_tech:20260114182222p:plain:alt=npmで@modelcontextprotocol/sdkの間接的に依存するパッケージが確認できる]
...
[f:id:guitarrapc_tech:20260114182231p:plain:alt=NuGetのパッケージ依存関係]
