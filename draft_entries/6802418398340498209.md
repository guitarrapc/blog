...
30/Mar/2013にあった、めとべやでのセッションで[Xingle先生]("http://xin9le.net/")が、PowerShellの限界とか、PowerShellダメ!! とか言われたので試しました。 いえ別にムキにはなっていませんし、Surface開けて真っ先にやったことがPowershellなんてこともありません。
## PowerShell ISEがない
