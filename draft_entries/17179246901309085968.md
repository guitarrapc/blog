...
PulumiはTerraform同様に、リソースの特定のプロパティの変更を無視するために`IgnoreChanges`オプションを提供しています。
[ドキュメント](https://www.pulumi.com/docs/iac/concepts/resources/options/ignorechanges/)で解説されているのですが、Pulumiで入れ子のキーをIgnoreChangesで無視する方法について記載がないようなのでメモしておきます。
