...
さて、今回は、mysqladminのextendedstatusで出力したログから、キーワード指定で値を取得するものです。
...
[GitHub / PowerShellUtil / Get-ParseMySQLAdminExtendedLog ](https://github.com/guitarrapc/PowerShellUtil/tree/master/Get-ParseMySQLAdminExtendedLog)
