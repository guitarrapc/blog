---
Title: GitHub ActionsでダウンロードしたActionsをいじる
Category:
  - GitHub Actions
...
GitHub Actionsが他CIと決定的に違うポイントの1つが[カスタムアクション](https://docs.github.com/ja/actions/sharing-automations/creating-actions/about-custom-actions)です。他のCIサービスにも類するものはありますが、圧倒的なボリュームと参照しやすさ、作りやすさからGitHub Actionsは他のCIサービスとは一線を画しています。[^1]

今回はそんなカスタムアクションを「使う」ときの豆知識です。
