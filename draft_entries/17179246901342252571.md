...
2025年にリリースされたTerraform 1.10.0で[Ephemeral resource](https://developer.hashicorp.com/terraform/language/manage-sensitive-data)が導入され、その値はStateファイルに残らなくなりました。Ephemeral resourceが利用できるかはリソースの対応を待つ必要があるのですが、2025年10月にterraform-provider-sops 1.3.0がEphemeral resource対応しました。
